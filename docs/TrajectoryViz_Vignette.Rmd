...
The package has been developed with following example use case in mind: • We have access to patient-level treatment trajectories and we can transform those into discrete sequences (with Cohort2Trajectory) - 1 event at a time with equal time slots following each other.
